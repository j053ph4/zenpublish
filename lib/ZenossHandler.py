...
class ZenossHandler():
    ...
    def createEvent(self, summary='', device=None, component=None, severity=3, evclasskey=None, evclass=None):
        '''create a new event'''
        data = {'summary': summary, 'device': device, 'component': component, 'severity':severity, 'evclasskey': evclasskey, 'evclass': evclass}
        return self.request('EventsRouter','add_event',[data])
